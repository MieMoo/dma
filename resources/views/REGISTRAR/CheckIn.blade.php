...
<style>
    * {
    ...
    .controls {
        ...
        position: relative;
        top: 110px;
        /* Below the total-transactions box */
        height: 70px;
    }
...
<div id="logoutModal" class="modal" style="display: none;">
    ...
    <div class="main-content">
        <!-- Back Button -->
        <button type="button" class="back-button">Check-In</button>
        <button class="total-transactions">
            <h2>1</h2>
            <p>Checked-In</p>
        </button>
        <!-- Controls -->
        <div class="controls">
            ...
            <form action="{{ route('registrar.checkIn') }}" method="GET">
